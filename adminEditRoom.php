...
if (isset($_POST['btnUpdate'])) {
    ...
    if (isset($_FILES['RoomImage']) && $_FILES['RoomImage']['error'] === UPLOAD_ERR_OK) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo "window.location = 'adminViewRoom.php';";
            echo "</script>";
        } else {
...
<div class="img4"></div>
    <div class="container">
        <h2>Room Information</h2>
            <?php
    $query = "SELECT * FROM room INNER JOIN hotel ON room.hotel_id=hotel.hotel_id WHERE room.room_id='$roomID'";
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="right">
                    ...
                    <div class="btn2">
                        <a href="adminViewRoom.php"><input class="btn2-style" type="button" value="Back" id="btn" onclick="history.go(-1)"></a>
                    </div>
                    <div class="btn1">
