...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['pricefilter'])) {
    ...
    switch ($pricetype) {
        case "1":
            $query = "SELECT * FROM hotel WHERE CEILING(rating) = 1 OR CEILING(rating) = 0 OR FLOOR(rating) =1";
            break;
        case "2":
            $query = "SELECT * FROM hotel WHERE FLOOR(rating) = 2";
            break;
        case "3":
            $query = "SELECT * FROM hotel WHERE FLOOR(rating) = 3";
            break;
        case "4":
            $query = "SELECT * FROM hotel WHERE FLOOR(rating) = 4";
            break;
        case "5":
            $query = "SELECT * FROM hotel WHERE CEILING(rating) = 5 OR FLOOR(rating) = 5";
            break;
        default:
            $query = "SELECT * FROM hotel";
            break;
