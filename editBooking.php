        ...
        <form action="#" method="POST">
            ...
            <div class="right">
                ...
                <div class="price">
                    ...
                    <div class="btn1">
                        <button class="btn1-style" type="submit" value="Update" name="btnUpdate" onclick="window.location.href='viewBooking.php'"><b>Update </b></button>
                    </div>
                    <div class="btn2">
                        <button class="btn2-style" type="button" value="cancel" name="cancelBtn" onclick="window.location.href='viewBooking.php'"><b>Back </b></button><br/>
                    </div>
            </form>
        </div>
